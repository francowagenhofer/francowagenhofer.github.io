...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:hn,depthTest:!1,depthWrite:!1})}function Ha(){return new tn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Zs(),fragmentShader:`
		...
		`,blending:hn,depthTest:!1,depthWrite:!1})}function ka(){return new tn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Zs(),fragmentShader:`
	...
	`}function bh(n){let e=new WeakMap,t=null;function i(o){if(o&&o.isTexture){const l=o.mapping,c=l===as||l===os,d=l===ni||l===ii;if(c||d){let p=e.get(o);const f=p!==void 0?p.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new Ba(n)),p=c?t.fromEquirectangular(o,p):t.fromCubemap(o,p),p.texture.pmremVersion=o.pmremVersion,e.set(o,p),p.texture;if(p!==void 0)return p.texture;{const m=o.image;return c&&m&&m.height>0||d&&m&&r(m)?(t===null&&(t=new Ba(n)),p=c?t.fromEquirectangular(o):t.fromCubemap(o),p.texture.pmremVersion=o.pmremVersion,e.set(o,p),o.addEventListener("dispose",s),p.texture):null}}}return o}function r(o){let l=0;const c=6;for(let d=0;d<c;d++)o[d]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:a}}function Th(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&nr("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function Ah(n,e,t,i){const r={},s=new WeakMap;function a(p){const f=p.target;f.index!==null&&e.remove(f.index);for(const v in f.attributes)e.remove(f.attributes[v]);for(const v in f.morphAttributes){const M=f.morphAttributes[v];for(let u=0,h=M.length;u<h;u++)e.remove(M[u])}f.removeEventListener("dispose",a),delete r[f.id];const m=s.get(f);m&&(e.remove(m),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(p,f){return r[f.id]===!0||(f.addEventListener("dispose",a),r[f.id]=!0,t.memory.geometries++),f}function l(p){const f=p.attributes;for(const v in f)e.update(f[v],n.ARRAY_BUFFER);const m=p.morphAttributes;for(const v in m){const M=m[v];for(let u=0,h=M.length;u<h;u++)e.update(M[u],n.ARRAY_BUFFER)}}function c(p){const f=[],m=p.index,v=p.attributes.position;let M=0;if(m!==null){const T=m.array;M=m.version;for(let y=0,b=T.length;y<b;y+=3){const B=T[y+0],P=T[y+1],A=T[y+2];f.push(B,P,P,A,A,B)}}else if(v!==void 0){const T=v.array;M=v.version;for(let y=0,b=T.length/3-1;y<b;y+=3){const B=y+0,P=y+1,A=y+2;f.push(B,P,P,A,A,B)}}else return;const u=new(Do(f)?zo:Bo)(f,1);u.version=M;const h=s.get(p);h&&e.remove(h),s.set(p,u)}function d(p){const f=s.get(p);if(f){const m=p.index;m!==null&&f.version<m.version&&c(p)}else c(p);return s.get(p)}return{get:o,update:l,getWireframeAttribute:d}}function wh(n,e,t){let i;function r(f){i=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function l(f,m){n.drawElements(i,m,s,f*a),t.update(m,i,1)}function c(f,m,v){v!==0&&(n.drawElementsInstanced(i,m,s,f*a,v),t.update(m,i,v))}function d(f,m,v){if(v===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,m,0,s,f,0,v);let u=0;for(let h=0;h<v;h++)u+=m[h];t.update(u,i,1)}function p(f,m,v,M){if(v===0)return;const u=e.get("WEBGL_multi_draw");if(u===null)for(let h=0;h<f.length;h++)c(f[h]/a,m[h],M[h]);else{u.multiDrawElementsInstancedWEBGL(i,m,0,s,f,0,M,0,v);let h=0;for(let T=0;T<v;T++)h+=m[T];for(let T=0;T<M.length;T++)t.update(h,i,M[T])}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=d,this.renderMultiDrawInstances=p}function Rh(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(s/3);break;case n.LINES:t.lines+=o*(s/2);break;case n.LINE_STRIP:t.lines+=o*(s-1);break;case n.LINE_LOOP:t.lines+=o*s;break;case n.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function Ch(n,e,t){const i=new WeakMap,r=new tt;function s(a,o,l){const c=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,p=d!==void 0?d.length:0;let f=i.get(o);if(f===void 0||f.count!==p){let g=function(){F.dispose(),i.delete(o),o.removeEventListener("dispose",g)};var m=g;f!==void 0&&f.texture.dispose();const v=o.morphAttributes.position!==void 0,M=o.morphAttributes.normal!==void 0,u=o.morphAttributes.color!==void 0,h=o.morphAttributes.position||[],T=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let b=0;v===!0&&(b=1),M===!0&&(b=2),u===!0&&(b=3);let B=o.attributes.position.count*b,P=1;B>e.maxTextureSize&&(P=Math.ceil(B/e.maxTextureSize),B=e.maxTextureSize);const A=new Float32Array(B*P*4*p),F=new Uo(A,B,P,p);F.type=jt,F.needsUpdate=!0;const Q=b*4;for(let S=0;S<p;S++){const G=h[S],z=T[S],W=y[S],K=B*P*4*S;for(let U=0;U<G.count;U++){const $=U*Q;v===!0&&(r.fromBufferAttribute(G,U),A[K+$+0]=r.x,A[K+$+1]=r.y,A[K+$+2]=r.z,A[K+$+3]=0),M===!0&&(r.fromBufferAttribute(z,U),A[K+$+4]=r.x,A[K+$+5]=r.y,A[K+$+6]=r.z,A[K+$+7]=0),u===!0&&(r.fromBufferAttribute(W,U),A[K+$+8]=r.x,A[K+$+9]=r.y,A[K+$+10]=r.z,A[K+$+11]=W.itemSize===4?r.w:1)}}f={count:p,texture:F,size:new ke(B,P)},i.set(o,f),o.addEventListener("dispose",g)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let v=0;for(let u=0;u<c.length;u++)v+=c[u];const M=o.morphTargetsRelative?1:1-v;l.getUniforms().setValue(n,"morphTargetBaseInfluence",M),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",f.size)}return{update:s}}function Ph(n,e,t,i){let r=new WeakMap;function s(l){const c=i.render.frame,d=l.geometry,p=e.get(l,d);if(r.get(p)!==c&&(e.update(p),r.set(p,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;r.get(f)!==c&&(f.update(),r.set(f,c))}return p}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:a}}class Xo extends xt{constructor(e,t,i,r,s,a,o,l,c,d=Zn){if(d!==Zn&&d!==si)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&d===Zn&&(i=Ln),i===void 0&&d===si&&(i=ri),super(null,r,s,a,o,l,d,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Ct,this.minFilter=l!==void 0?l:Ct,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const qo=new xt,Ga=new Xo(1,1),Yo=new Uo,Ko=new mc,$o=new Go,Va=[],Wa=[],Xa=new Float32Array(16),qa=new Float32Array(9),Ya=new Float32Array(4);function ci(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=Va[r];if(s===void 0&&(s=new Float32Array(r),Va[r]=s),e!==0){i.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(s,o)}return s}function st(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function at(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function fr(n,e){let t=Wa[e];t===void 0&&(t=new Int32Array(e),Wa[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function Lh(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function Dh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(st(t,e))return;n.uniform2fv(this.addr,e),at(t,e)}}function Ih(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(st(t,e))return;n.uniform3fv(this.addr,e),at(t,e)}}function Uh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(st(t,e))return;n.uniform4fv(this.addr,e),at(t,e)}}function Nh(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(st(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),at(t,e)}else{if(st(t,i))return;Ya.set(i),n.uniformMatrix2fv(this.addr,!1,Ya),at(t,i)}}function Fh(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(st(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),at(t,e)}else{if(st(t,i))return;qa.set(i),n.uniformMatrix3fv(this.addr,!1,qa),at(t,i)}}function Oh(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(st(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),at(t,e)}else{if(st(t,i))return;Xa.set(i),n.uniformMatrix4fv(this.addr,!1,Xa),at(t,i)}}function Bh(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function zh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(st(t,e))return;n.uniform2iv(this.addr,e),at(t,e)}}function Hh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(st(t,e))return;n.uniform3iv(this.addr,e),at(t,e)}}function kh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(st(t,e))return;n.uniform4iv(this.addr,e),at(t,e)}}function Gh(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function Vh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(st(t,e))return;n.uniform2uiv(this.addr,e),at(t,e)}}function Wh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(st(t,e))return;n.uniform3uiv(this.addr,e),at(t,e)}}function Xh(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(st(t,e))return;n.uniform4uiv(this.addr,e),at(t,e)}}function qh(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(Ga.compareFunction=Lo,s=Ga):s=qo,t.setTexture2D(e||s,r)}function Yh(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||Ko,r)}function Kh(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||$o,r)}function $h(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||Yo,r)}function jh(n){switch(n){case 5126:return Lh;case 35664:return Dh;case 35665:return Ih;case 35666:return Uh;case 35674:return Nh;case 35675:return Fh;case 35676:return Oh;case 5124:case 35670:return Bh;case 35667:case 35671:return zh;case 35668:case 35672:return Hh;case 35669:case 35673:return kh;case 5125:return Gh;case 36294:return Vh;case 36295:return Wh;case 36296:return Xh;case 35678:case 36198:case 36298:case 36306:case 35682:return qh;case 35679:case 36299:case 36307:return Yh;case 35680:case 36300:case 36308:case 36293:return Kh;case 36289:case 36303:case 36311:case 36292:return $h}}function Zh(n,e){n.uniform1fv(this.addr,e)}function Jh(n,e){const t=ci(e,this.size,2);n.uniform2fv(this.addr,t)}function Qh(n,e){const t=ci(e,this.size,3);n.uniform3fv(this.addr,t)}function ef(n,e){const t=ci(e,this.size,4);n.uniform4fv(this.addr,t)}function tf(n,e){const t=ci(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function nf(n,e){const t=ci(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function rf(n,e){const t=ci(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function sf(n,e){n.uniform1iv(this.addr,e)}function af(n,e){n.uniform2iv(this.addr,e)}function of(n,e){n.uniform3iv(this.addr,e)}function lf(n,e){n.uniform4iv(this.addr,e)}function cf(n,e){n.uniform1uiv(this.addr,e)}function uf(n,e){n.uniform2uiv(this.addr,e)}function df(n,e){n.uniform3uiv(this.addr,e)}function hf(n,e){n.uniform4uiv(this.addr,e)}function ff(n,e,t){const i=this.cache,r=e.length,s=fr(t,r);st(i,s)||(n.uniform1iv(this.addr,s),at(i,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||qo,s[a])}function pf(n,e,t){const i=this.cache,r=e.length,s=fr(t,r);st(i,s)||(n.uniform1iv(this.addr,s),at(i,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Ko,s[a])}function mf(n,e,t){const i=this.cache,r=e.length,s=fr(t,r);st(i,s)||(n.uniform1iv(this.addr,s),at(i,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||$o,s[a])}function gf(n,e,t){const i=this.cache,r=e.length,s=fr(t,r);st(i,s)||(n.uniform1iv(this.addr,s),at(i,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||Yo,s[a])}function _f(n){switch(n){case 5126:return Zh;case 35664:return Jh;case 35665:return Qh;case 35666:return ef;case 35674:return tf;case 35675:return nf;case 35676:return rf;case 5124:case 35670:return sf;case 35667:case 35671:return af;case 35668:case 35672:return of;case 35669:case 35673:return lf;case 5125:return cf;case 36294:return uf;case 36295:return df;case 36296:return hf;case 35678:case 36198:case 36298:case 36306:case 35682:return ff;case 35679:case 36299:case 36307:return pf;case 35680:case 36300:case 36308:case 36293:return mf;case 36289:case 36303:case 36311:case 36292:return gf}}class vf{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=jh(t.type)}}class xf{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=_f(t.type)}}class Sf{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],i)}}}const Yr=/(\w+)(\])?(\[|\.)?/g;function Ka(n,e){n.seq.push(e),n.map[e.id]=e}function Mf(n,e,t){const i=n.name,r=i.length;for(Yr.lastIndex=0;;){const s=Yr.exec(i),a=Yr.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){Ka(t,c===void 0?new vf(o,n,e):new xf(o,n,e));break}else{let p=t.map[o];p===void 0&&(p=new Sf(o),Ka(t,p)),t=p}}}class ir{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);Mf(s,a,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&i.push(a)}return i}}function $a(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const yf=37297;let Ef=0;function bf(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;i.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return i.join(`
`)}function Tf(n){const e=We.getPrimaries(We.workingColorSpace),t=We.getPrimaries(n);let i;switch(e===t?i="":e===ar&&t===sr?i="LinearDisplayP3ToLinearSRGB":e===sr&&t===ar&&(i="LinearSRGBToLinearDisplayP3"),n){case mn:case dr:return[i,"LinearTransferOETF"];case Ot:case Ks:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[i,"LinearTransferOETF"]}}function ja(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=n.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+bf(n.getShaderSource(e),a)}else return r}function Af(n,e){const t=Tf(e);return`vec4 ${n}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function wf(n,e){let t;switch(e){case Hl:t="Linear";break;case kl:t="Reinhard";break;case Gl:t="Cineon";break;case Vl:t="ACESFilmic";break;case Xl:t="AgX";break;case ql:t="Neutral";break;case Wl:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ki=new O;function Rf(){We.getLuminanceCoefficients(Ki);const n=Ki.x.toFixed(4),e=Ki.y.toFixed(4),t=Ki.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Cf(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(gi).join(`
`)}function Pf(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function Lf(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),a=s.name;let o=1;s.type===n.FLOAT_MAT2&&(o=2),s.type===n.FLOAT_MAT3&&(o=3),s.type===n.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:n.getAttribLocation(e,a),locationSize:o}}return t}function gi(n){return n!==""}function Za(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ja(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Df=/^[ \t]*#include +<([\w\d./]+)>/gm;function Os(n){return n.replace(Df,Uf)}const If=new Map;function Uf(n,e){let t=Ce[e];if(t===void 0){const i=If.get(e);if(i!==void 0)t=Ce[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Os(t)}const Nf=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Qa(n){return n.replace(Nf,Ff)}function Ff(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function eo(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function Of(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===vo?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===xl?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Kt&&(e="SHADOWMAP_TYPE_VSM"),e}function Bf(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case ni:case ii:e="ENVMAP_TYPE_CUBE";break;case ur:e="ENVMAP_TYPE_CUBE_UV";break}return e}function zf(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case ii:e="ENVMAP_MODE_REFRACTION";break}return e}function Hf(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case xo:e="ENVMAP_BLENDING_MULTIPLY";break;case Bl:e="ENVMAP_BLENDING_MIX";break;case zl:e="ENVMAP_BLENDING_ADD";break}return e}function kf(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function Gf(n,e,t,i){const r=n.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Of(t),c=Bf(t),d=zf(t),p=Hf(t),f=kf(t),m=Cf(t),v=Pf(s),M=r.createProgram();let u,h,T=t.glslVersion?"#version "+t.glslVersion+`
...
`,uo=n=>{n.id=jo,n.href="https://neat.firecms.co",n.target="_blank",n.style.position="absolute",n.style.display="block",n.style.bottom="0",n.style.right="0",n.style.padding="10px",n.style.color="#dcdcdc",n.style.opacity="0.8",n.style.fontFamily="sans-serif",n.style.fontSize="16px",n.style.fontWeight="bold",n.style.textDecoration="none",n.style.zIndex="10000",n.innerHTML="NEAT"},Cp=n=>{const e=n.parentElement?.getElementsByTagName("a");if(e){for(let i=0;i<e.length;i++)if(e[i].id===jo){uo(e[i]);return}}const t=document.createElement("a");uo(t),n.parentElement?.appendChild(t)};function Pp(){const n=new Date,e=n.getMinutes(),t=n.getSeconds();return e*60+t}function Lp(n=6){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";let t="";for(let i=0;i<n;i++){const r=Math.floor(Math.random()*e.length);t+=e.charAt(r)}return t}function Dp(n,e){const t=document.createElement("a");t.download=e,t.href=n,document.body.appendChild(t),t.click(),document.body.removeChild(t)}const Ip={colors:[{color:"#1A1C20",enabled:!0},{color:"#22252B",enabled:!0},{color:"#2B2E34",enabled:!0},{color:"#2E3240",enabled:!0},{color:"#1E222C",enabled:!0}],speed:1,horizontalPressure:3,verticalPressure:5,waveFrequencyX:1,waveFrequencyY:3,waveAmplitude:12,shadows:0,highlights:1.4,colorBrightness:.88,colorSaturation:2,wireframe:!1,colorBlending:7,backgroundColor:"#141516",backgroundAlpha:1,grainScale:2,grainSparsity:0,grainIntensity:.12,grainSpeed:1,resolution:1,yOffset:0},Up={colors:[{color:"#FFFFFF",enabled:!0},{color:"#FDF9F3",enabled:!0},{color:"#E9E4DA",enabled:!0}],speed:5,horizontalPressure:7,verticalPressure:8,waveFrequencyX:2,waveFrequencyY:1,waveAmplitude:8,shadows:4,highlights:6,colorBrightness:.95,colorSaturation:2,wireframe:!1,colorBlending:10,backgroundColor:"#FDF9F3",backgroundAlpha:1,grainScale:4,grainSparsity:0,grainIntensity:.25,grainSpeed:1,resolution:1,yOffset:0};function Np(n){const e=document.documentElement;document.body.classList.remove("dark","light"),document.body.classList.add(n),n==="light"?(e.style.setProperty("--blend-title-color","rgba(55, 39, 19, 0.6)"),e.style.setProperty("--navbar-bg","rgba(192, 165, 149, 0.16)"),e.style.setProperty("--navbar-border","rgba(77, 77, 77, 0.07)"),e.style.setProperty("--navbar-link-hover","#B77A14"),e.style.setProperty("--navbar-link-hover","#70573dff"),e.style.setProperty("--link-color","#3C2F22"),e.style.setProperty("--link-card-color","#3C2F22cc"),e.style.setProperty("--link-hover-color","#c28a11d5"),e.style.setProperty("--link-hover-color","#32271ca6"),e.style.setProperty("--link-color","#3C2F22"),e.style.setProperty("--navbar-link-hover","#a87c3eff"),e.style.setProperty("--link-hover-color","#bd955d60"),e.style.setProperty("--toggle-bg","#6a5025a7"),e.style.setProperty("--toggle-bg","#584321a7"),e.style.setProperty("--toggle-bg-hover","#BFA47A"),e.style.setProperty("--toggle-ball","#F8F6F2"),e.style.setProperty("--toggle-glow","0 0 6px rgba(255, 230, 180, 0.45)"),e.style.setProperty("--link-contacto","#444"),e.style.setProperty("--link-contacto-hover","#111"),e.style.setProperty("--link-contacto-bg-hover","rgba(0, 0, 0, 0.05)"),e.style.setProperty("--contact-link-shadow","0 1px 3px rgba(0,0,0,0.10)"),e.style.setProperty("--contact-link-shadow-hover","0 2px 6px rgba(0,0,0,0.16)"),e.style.setProperty("--btn-bg","#bfa57add"),e.style.setProperty("--btn-hover-bg","#6a5025a7"),e.style.setProperty("--btn-secondary-bg","transparent"),e.style.setProperty("--btn-secondary-color","#BFA47A"),e.style.setProperty("--card-bg","rgba(185, 174, 154, 0.23)"),e.style.setProperty("--card-hover-bg","rgba(238, 238, 238, 0.35)"),e.style.setProperty("--proyect-btn-color","#23150688"),e.style.setProperty("--proyect-btn-hover-color","#bfa57a98"),e.style.setProperty("--proyect-text-color","#ffffffff"),e.style.setProperty("--btn-vermas-text","#231506c9"),e.style.setProperty("--proyect-text-hover-color","white"),e.style.setProperty("--background-tecn-card","rgba(185, 174, 154, 0.25)"),e.style.setProperty("--section-bg","rgba(185, 174, 154, 0.29)"),e.style.setProperty("--btn-form-bg","#272219e4"),e.style.setProperty("--btn-form-hover-bg","#2a1f15b9"),e.style.setProperty("--btn-form-text","#fff"),e.style.setProperty("--btn-form-hover-text","#fff"),e.style.setProperty("--fondo-modal","rgba(0, 0, 0, 0.55)"),e.style.setProperty("--modal-background","#897f7d65"),e.style.setProperty("--modal-bg","#fffffff6"),e.style.setProperty("--modal-text","#3C2F22"),e.style.setProperty("--flechas","#3C2F22"),e.style.setProperty("--modal-chip-bg ","rgba(0,0,0,0.06)"),e.style.setProperty("--modal-chip-border","rgba(0,0,0,0.15)"),e.style.setProperty("--text-color","#3C2F22"),e.style.setProperty("--footer","#2C241D"),e.style.setProperty("--footer-hover","#1A1612"),e.style.setProperty("--footer-background","rgba(185, 174, 154, 0.17)"),e.style.setProperty("--footer-border","rgba(215, 183, 154, 0.18)")):(e.style.setProperty("--blend-title-color","rgb(202, 228, 233)"),e.style.setProperty("--navbar-bg","rgba(12, 12, 14, 0.57)"),e.style.setProperty("--navbar-text-color","white"),e.style.setProperty("--navbar-border","rgba(168, 168, 168, 0.06)"),e.style.setProperty("--link-color","#ffffffff"),e.style.setProperty("--navbar-link-hover","#a5e0e9ff"),e.style.setProperty("--navbar-link-hover","#8fe6f4ff"),e.style.setProperty("--link-hover-color","#8fe7f4c2"),e.style.setProperty("--toggle-bg","#4d58795a"),e.style.setProperty("--toggle-bg-hover","#5c678889"),e.style.setProperty("--toggle-bg-hover","#4c557089"),e.style.setProperty("--toggle-ball","#fff"),e.style.setProperty("--link-contacto"," #d6d6d6"),e.style.setProperty("--link-contacto-hover","#ffffff"),e.style.setProperty("--link-contacto-bg-hover"," rgba(255, 255, 255, 0.08)"),e.style.setProperty("--contact-link-shadow","0 1px 4px rgba(255,255,255,0.08)"),e.style.setProperty("--contact-link-shadow-hover","0 3px 8px rgba(255,255,255,0.12)"),e.style.setProperty("--btn-bg","#03a9f4"),e.style.setProperty("--btn-secondary-bg","transparent"),e.style.setProperty("--btn-secondary-color","#03a9f4"),e.style.setProperty("--btn-form-bg","#2B3C8D"),e.style.setProperty("--btn-form-hover-bg","#188efdb4"),e.style.setProperty("--btn-form-hover-text","#fff"),e.style.setProperty("--card-bg","rgba(255, 255, 255, 0.07)"),e.style.setProperty("--card-hover-bg","rgba(57, 54, 63, 0.15)"),e.style.setProperty("--bg-color","#020210"),e.style.setProperty("--proyect-btn-color","rgba(255, 255, 255, 0.1)"),e.style.setProperty("--proyect-btn-hover-color","#17518fd9"),e.style.setProperty("--proyect-text-color","rgba(255, 255, 255, 1)"),e.style.setProperty("--proyect-text-hover-color","rgba(255, 255, 255, 1)"),e.style.setProperty("--btn-vermas-text","rgba(255, 255, 255, 1)"),e.style.setProperty("--background-tecn-card","rgba(255, 255, 255, 0.033)"),e.style.setProperty("--fondo-modal","transparent"),e.style.setProperty("--modal-background","#0d0e0f63"),e.style.setProperty("--modal-bg","#0d0e0efb"),e.style.setProperty("--modal-bg","#3a3f4eb0"),e.style.setProperty("--modal-text","#f9f9f9ff"),e.style.setProperty("--flechas","#f9f9f9ff"),e.style.setProperty("--modal-chip-bg ","rgba(255,255,255,0.08)"),e.style.setProperty("--modal-chip-border","rgba(255,255,255,0.15)"),e.style.setProperty("--text-color","white"),e.style.setProperty("--section-bg","rgba(0, 0, 0, 0.6)"),e.style.setProperty("--footer","rgba(255, 255, 255, 0.82)"),e.style.setProperty("--footer-hover","rgba(255, 255, 255, 1)"),e.style.setProperty("--footer-background","rgba(0, 0, 0, 0.25)"),e.style.setProperty("--footer-border","rgba(255, 255, 255, 0.06)"))}const Ze="/",oi=[{id:"modal1",titulo:".MovieApp",tipo:"App web",framework:"MVC",descripcion:"Catálogo de películas con sistema de reseñas, favoritos, calificaciones y más.",iconos:[`${Ze}Iconos/csharp.svg`,`${Ze}Iconos/dotnet2.svg`,`${Ze}Iconos/bootstrap.svg`,`${Ze}Iconos/sql-server.svg`],boton:{texto:"Ver Repositorio",link:"https://github.com/francowagenhofer/movieapp-mvc-dotnet"},modalTexto:`
    ...
    `,techList:["<strong>Frontend:</strong> Razor Views, HTML, CSS, Bootstrap","<strong>Backend:</strong> C#, ASP.NET MVC (.NET 9)","<strong>ORM:</strong> Entity Framework Core","<strong>Base de datos:</strong> SQL Server","<strong>Autenticación:</strong> ASP.NET Identity","<strong>IDE:</strong> Visual Studio 2022"],methodsList:["<strong>Lógica:</strong> POO y arquitectura MVC","<strong>Gestión:</strong> CRUD con validaciones","<strong>Consultas:</strong> LINQ y T-SQL","<strong>Seguridad:</strong> Sistema de roles (admin/usuario)","<strong>Features:</strong> Reviews, favoritos, filtros dinámicos"],repos:[],imagenes:[`${Ze}Imagenes/MovieApp/home.webp`,`${Ze}Imagenes/MovieApp/movie.webp`,`${Ze}Imagenes/MovieApp/favoritos.webp`,`${Ze}Imagenes/MovieApp/reseñas.webp`,`${Ze}Imagenes/MovieApp/admin.webp`]},{id:"modal2",titulo:"CatálogoWeb",tipo:"App web",framework:"web forms",descripcion:"Plataforma web para administrar y filtrar productos con control de acceso.",iconos:[`${Ze}Iconos/csharp.svg`,`${Ze}Iconos/dotnet2.svg`,`${Ze}Iconos/bootstrap.svg`,`${Ze}Iconos/sql-server.svg`],boton:{texto:"Sitio Web",link:"http://webcatalog.somee.com/"},modalTexto:`
        ...
        `,techList:["<strong>Frontend:</strong> Windows Forms","<strong>Backend:</strong> C#","<strong>Base de datos:</strong> SQL Server / SQLite","<strong>IDE:</strong> Visual Studio"],methodsList:["<strong>Lógica:</strong> POO","<strong>Arquitectura:</strong> Capas (dominio, negocio, UI)","<strong>Gestión:</strong> CRUD con validaciones","<strong>Consultas:</strong> T-SQL y joins"],repos:[{label:"SQLite",link:"https://github.com/francowagenhofer/Gestion-Pyme-SQLite.git"},{label:"SQL Server",link:"https://github.com/francowagenhofer/app-gestion-empleados-csharp.git"}],imagenes:[`${Ze}Imagenes/GestorEmpleados/MenuEscritorio.webp`,`${Ze}Imagenes/GestorEmpleados/GestionOperaciones.webp`,`${Ze}Imagenes/GestorEmpleados/MenuConsola.webp`,`${Ze}Imagenes/GestorEmpleados/GestionEmpleadosDB.webp`]}];class Ti{constructor(e=0,t="Network Error"){this.status=e,this.text=t}}const Fp=()=>{if(!(typeof localStorage>"u"))return{get:n=>Promise.resolve(localStorage.getItem(n)),set:(n,e)=>Promise.resolve(localStorage.setItem(n,e)),remove:n=>Promise.resolve(localStorage.removeItem(n))}},ct={origin:"https://api.emailjs.com",blockHeadless:!1,storageProvider:Fp()},Js=n=>n?typeof n=="string"?{publicKey:n}:n.toString()==="[object Object]"?n:{}:{},Op=(n,e="https://api.emailjs.com")=>{if(!n)return;const t=Js(n);ct.publicKey=t.publicKey,ct.blockHeadless=t.blockHeadless,ct.storageProvider=t.storageProvider,ct.blockList=t.blockList,ct.limitRate=t.limitRate,ct.origin=t.origin||e},Zo=async(n,e,t={})=>{const i=await fetch(ct.origin+n,{method:"POST",headers:t,body:e}),r=await i.text(),s=new Ti(i.status,r);if(i.ok)return s;throw s},Jo=(n,e,t)=>{if(!n||typeof n!="string")throw"The public key is required. Visit https://dashboard.emailjs.com/admin/account";if(!e||typeof e!="string")throw"The service ID is required. Visit https://dashboard.emailjs.com/admin";if(!t||typeof t!="string")throw"The template ID is required. Visit https://dashboard.emailjs.com/admin/templates"},Bp=n=>{if(n&&n.toString()!=="[object Object]")throw"The template params have to be the object. Visit https://www.emailjs.com/docs/sdk/send/"},Qo=n=>n.webdriver||!n.languages||n.languages.length===0,el=()=>new Ti(451,"Unavailable For Headless Browser"),zp=(n,e)=>{if(!Array.isArray(n))throw"The BlockList list has to be an array";if(typeof e!="string")throw"The BlockList watchVariable has to be a string"},Hp=n=>!n.list?.length||!n.watchVariable,kp=(n,e)=>n instanceof FormData?n.get(e):n[e],tl=(n,e)=>{if(Hp(n))return!1;zp(n.list,n.watchVariable);const t=kp(e,n.watchVariable);return typeof t!="string"?!1:n.list.includes(t)},nl=()=>new Ti(403,"Forbidden"),Gp=(n,e)=>{if(typeof n!="number"||n<0)throw"The LimitRate throttle has to be a positive number";if(e&&typeof e!="string")throw"The LimitRate ID has to be a non-empty string"},Vp=async(n,e,t)=>{const i=Number(await t.get(n)||0);return e-Date.now()+i},il=async(n,e,t)=>{if(!e.throttle||!t)return!1;Gp(e.throttle,e.id);const i=e.id||n;return await Vp(i,e.throttle,t)>0?!0:(await t.set(i,Date.now().toString()),!1)},rl=()=>new Ti(429,"Too Many Requests"),Wp=async(n,e,t,i)=>{const r=Js(i),s=r.publicKey||ct.publicKey,a=r.blockHeadless||ct.blockHeadless,o=r.storageProvider||ct.storageProvider,l={...ct.blockList,...r.blockList},c={...ct.limitRate,...r.limitRate};return a&&Qo(navigator)?Promise.reject(el()):(Jo(s,n,e),Bp(t),t&&tl(l,t)?Promise.reject(nl()):await il(location.pathname,c,o)?Promise.reject(rl()):Zo("/api/v1.0/email/send",JSON.stringify({lib_version:"4.4.1",user_id:s,service_id:n,template_id:e,template_params:t}),{"Content-type":"application/json"}))},Xp=n=>{if(!n||n.nodeName!=="FORM")throw"The 3rd parameter is expected to be the HTML form element or the style selector of the form"},qp=n=>typeof n=="string"?document.querySelector(n):n,Yp=async(n,e,t,i)=>{const r=Js(i),s=r.publicKey||ct.publicKey,a=r.blockHeadless||ct.blockHeadless,o=ct.storageProvider||r.storageProvider,l={...ct.blockList,...r.blockList},c={...ct.limitRate,...r.limitRate};if(a&&Qo(navigator))return Promise.reject(el());const d=qp(t);Jo(s,n,e),Xp(d);const p=new FormData(d);return tl(l,p)?Promise.reject(nl()):await il(location.pathname,c,o)?Promise.reject(rl()):(p.append("lib_version","4.4.1"),p.append("service_id",n),p.append("template_id",e),p.append("user_id",s),Zo("/api/v1.0/email/send-form",p))},sl={init:Op,send:Wp,sendForm:Yp,EmailJSResponseStatus:Ti};sl.init("uWi6YuvGoxMA-TSfo");let dn="dark";const Kp=document.getElementById("gradient"),Qs=document.getElementById("theme-toggle");let al;const $p=document.querySelectorAll('[data-icon="github"]');function jp(n){const e=document.getElementById("navLogo"),t=document.getElementById("footerLogo"),i=n==="dark"?"Logos/logo_transparente_blanco.webp":"Logos/logo_transparente_negro.webp";e&&(e.src=i),t&&(t.src=i)}function Zp(n){const e=n==="dark"?"Iconos/GitHub_dark.svg":"Iconos/github.svg";$p.forEach(t=>t.src=e)}function ol(n){Np(n),Zp(n),jp(n)}function Jp(n){return window.innerWidth<1300?(n.resolution=.55,n.grainIntensity*=.5,n.speed*=.75,n.waveAmplitude*=.75):n.resolution=1,n}function ll(n){const t=Jp({...n==="dark"?Ip:Up});al=new Ap({ref:Kp,...t})}const Qp=localStorage.getItem("theme")||"dark";dn=Qp;ol(dn);Qs.checked=dn==="dark";ll(dn);function em(){dn=Qs.checked?"dark":"light",ol(dn),al.destroy(),ll(dn),localStorage.setItem("theme",dn)}Qs.addEventListener("change",em);const Bs=document.querySelector(".navbar");let ho=window.scrollY;window.addEventListener("scroll",()=>{const n=window.scrollY,e=n>ho,t=n>40;Bs.classList.toggle("scrolled",t),Bs.classList.toggle("hidden",e&&t),ho=n});document.addEventListener("mousemove",n=>{if(!document.body.classList.contains("modal-open")){const e=window.innerHeight*.2;n.clientY<e&&Bs.classList.remove("hidden")}});const tm=document.getElementById("projects-container"),nm=document.getElementById("project-template");oi.forEach(n=>{const t=nm.content.cloneNode(!0).querySelector(".project-card"),i=t.querySelector(".card-image");if(n.imagenes?.length){i.src=n.imagenes[0],i.alt=n.titulo;const o=t.querySelector(".card-image-wrapper");o.style.cursor="pointer",o.addEventListener("click",l=>{l.preventDefault(),window.dispatchEvent(new CustomEvent("open-overlay",{detail:{images:n.imagenes,index:0}}))})}if(t.querySelector(".card-title").textContent=n.titulo,t.querySelector(".card-description").textContent=n.descripcion,n.tipo){const o=t.querySelector(".card-badge-tipo .badge-text");o&&(o.textContent=n.tipo)}if(n.framework){const o=t.querySelector(".card-badge-framework .badge-text");o&&(o.textContent=n.framework)}const r=t.querySelectorAll(".card-tech img");n.iconos.forEach((o,l)=>{r[l]&&(r[l].src=o)});const s=t.querySelector(".card-download");n.boton?.link?(s.textContent=n.boton.texto,s.href=n.boton.link,s.target="_blank",s.rel="noopener noreferrer"):s.style.display="none";const a=t.querySelector(".open-modal");a.dataset.id=n.id,tm.appendChild(t)});const cl=document.querySelectorAll("section, article, .skill-card, .project-card, .contact-container");cl.forEach(n=>n.classList.add("reveal-item"));const ul=new IntersectionObserver(n=>{n.forEach((e,t)=>{e.isIntersecting?(e.target.style.transitionDelay=`${t*.05}s`,e.target.classList.add("visible")):e.target.classList.remove("visible")})},{threshold:.1});cl.forEach(n=>ul.observe(n));const jr=document.querySelector("#home"),im=[jr.querySelector(".blend-title"),jr.querySelector(".subtitle"),jr.querySelector(".hero-buttons")];im.forEach((n,e)=>{n.classList.add("hero-reveal"),n.style.transitionDelay=`${e*.1}s`,ul.observe(n)});const rm=document.querySelectorAll(`
  ...
  .card-download,
  .contact-btn-902
`);rm.forEach(n=>{n.addEventListener("click",()=>{n.classList.add("btn-click"),setTimeout(()=>n.classList.remove("btn-click"),250)})});document.addEventListener("click",n=>{const e=n.target.closest(".close-modal");if(!e)return;e.classList.add("clicked"),setTimeout(()=>e.classList.remove("clicked"),200);const t=e.closest(".project-modal");closeModal(t)});const fo=document.getElementById("contactForm"),En=document.getElementById("alertaGracias");fo.addEventListener("submit",function(n){n.preventDefault(),En.textContent="Enviando tu mensaje...",En.className="alerta show",sl.sendForm("service_fz2pgho","template_l9yc0yb",this).then(()=>{En.textContent="¡Gracias por tu mensaje! Me comunicaré contigo pronto.",En.className="alerta success show",fo.reset()},e=>{console.error("Error:",e),En.textContent="Error al enviar el mensaje. Intenta nuevamente.",En.className="alerta error show"}),setTimeout(()=>{En.classList.remove("show")},6e3)});const zs=document.getElementById("backToTop");window.addEventListener("scroll",()=>{window.scrollY>400?zs.classList.add("show"):zs.classList.remove("show")});zs.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});function ea(){const n=document.querySelector(".navbar .container"),e=document.getElementById("backToTop");if(!n||!e)return;const t=n.getBoundingClientRect(),i=window.innerWidth-t.right;e.style.right=i+8+"px"}function ta(){const n=document.querySelector(".navbar .container"),e=document.getElementById("footerLogo");if(!n||!e)return;const i=n.getBoundingClientRect().left;e.style.marginLeft=i+"px"}window.addEventListener("resize",()=>{ea(),ta()});window.addEventListener("DOMContentLoaded",()=>{ea(),ta()});ea();ta();const ji=document.querySelector(".scroll-indicator");if(ji){const n=document.getElementById("proyectos");window.addEventListener("scroll",()=>{if(!n)return;const t=n.getBoundingClientRect().top<window.innerHeight,i=window.scrollY<50;t&&!i?ji.classList.add("hidden"):ji.classList.remove("hidden")}),ji.addEventListener("click",()=>{n.scrollIntoView({behavior:"smooth"})})}const sm=document.querySelector(".navbar");let Hs=0;function dl(n){if(n<0||n>=oi.length)return;Hs=n;const e=oi[n],t=document.getElementById("project-modal");if(!t)return;t.querySelector(".modal-title").textContent=e.titulo,t.querySelector(".modal-text").innerHTML=e.modalTexto;const i=t.querySelector(".modal-text2");i&&(i.innerHTML="");const r=t.querySelector(".tech-list");r.innerHTML=e.techList.map(l=>`<li>${l}</li>`).join("");const s=t.querySelector(".methods-list");s.innerHTML=e.methodsList.map(l=>`<li>${l}</li>`).join("");const a=t.querySelector(".modal-links");a.querySelectorAll("a:not(.modal-download)").forEach(l=>l.remove()),e.repos.forEach(l=>{const c=document.createElement("a");c.className="btn btn-glow",c.href=l.link,c.target="_blank",c.textContent=l.label,a.insertBefore(c,a.querySelector(".modal-download"))});const o=t.querySelector(".modal-download");o.textContent=e.boton.texto,o.href=e.boton.link,am(e.imagenes)}document.addEventListener("click",n=>{const e=n.target.closest(".open-modal");if(!e)return;const t=oi.findIndex(s=>s.id===e.dataset.id);if(t===-1)return;const i=document.getElementById("project-modal");if(!i)return;const r=i.querySelector(".modal-content");r.classList.remove("modal-animate-out"),r.classList.remove("modal-animate-in"),i.classList.remove("hidden"),document.body.classList.add("modal-open"),sm.classList.remove("show"),r.offsetWidth,r.classList.add("modal-animate-in"),dl(t)});function na(){const n=document.getElementById("project-modal");if(!n)return;const e=n.querySelector(".modal-content");e.classList.remove("modal-animate-in"),e.classList.remove("modal-animate-out"),e.offsetWidth,e.classList.add("modal-animate-out"),e.addEventListener("animationend",()=>{n.classList.add("hidden"),document.body.classList.remove("modal-open")},{once:!0})}document.addEventListener("click",n=>{(n.target.closest(".close-modal")||n.target.closest(".modal-close-top"))&&na()});document.addEventListener("click",n=>{const e=n.target.closest(".next-project"),t=n.target.closest(".prev-project");e&&cr("next"),t&&cr("prev")});function cr(n){let e=n==="next"?Hs+1:Hs-1;e<0&&(e=oi.length-1),e>=oi.length&&(e=0);const i=document.getElementById("project-modal").querySelector(".modal-content");i.classList.remove("modal-animate-in"),i.classList.add("modal-animate-out"),setTimeout(()=>{dl(e),i.classList.remove("modal-animate-out"),i.offsetWidth,i.classList.add("modal-animate-in")},50)}window.addEventListener("click",n=>{const e=document.getElementById("project-modal");n.target===e&&na()});window.addEventListener("keydown",n=>{if(n.key==="Escape"){const e=document.getElementById("project-modal");e&&!e.classList.contains("hidden")&&na()}});window.addEventListener("keydown",n=>{const e=document.getElementById("project-modal");!e||e.classList.contains("hidden")||(n.key==="ArrowRight"&&cr("next"),n.key==="ArrowLeft"&&cr("prev"))});function am(n){const e=document.getElementById("project-modal");if(!e)return;const t=e.querySelector(".modal-gallery-slider"),i=e.querySelector(".gallery-prev"),r=e.querySelector(".gallery-next"),s=e.querySelector(".gallery-dots");if(!t||!i||!r||!s)return;let a=0,o=null;if(t.innerHTML="",s.innerHTML="",!n||n.length===0){t.innerHTML='<p style="text-align: center; padding: 20px;">Sin imágenes disponibles</p>';return}const l=i.cloneNode(!0),c=r.cloneNode(!0);i.replaceWith(l),r.replaceWith(c),n.forEach((m,v)=>{const M=document.createElement("div");M.classList.add("gallery-dot"),M.addEventListener("click",()=>{if(v===a)return;const u=v>a?"next":"prev";a=v,f(u)}),s.appendChild(M)});const d=()=>{s.querySelectorAll(".gallery-dot").forEach((m,v)=>{m.classList.toggle("active",v===a)})};function p(m){const v=document.createElement("div");v.classList.add("slide");const M=m.endsWith(".mp4")||m.endsWith(".webm");let u;return M?(u=document.createElement("video"),u.src=m,u.controls=!0):(u=document.createElement("img"),u.src=m,u.loading="lazy",u.addEventListener("click",()=>{hl(n,a)})),v.appendChild(u),v}function f(m="next"){if(n.length===0)return;const v=n[a],M=p(v);o&&t.querySelectorAll(".slide").forEach(u=>{u!==o&&u.remove()}),M.classList.add(m==="next"?"from-right":"from-left"),t.appendChild(M),requestAnimationFrame(()=>{o&&(o.classList.add(m==="next"?"to-left":"to-right"),o.addEventListener("transitionend",u=>{u.propertyName==="transform"&&o?.remove()},{once:!0})),M.classList.remove("from-right","from-left"),M.classList.add("is-active"),o=M}),d()}l.type="button",c.type="button",l.addEventListener("click",m=>{m.preventDefault(),a=(a-1+n.length)%n.length,f("prev")}),c.addEventListener("click",m=>{m.preventDefault(),a=(a+1)%n.length,f("next")}),f("next")}const Jt=document.getElementById("image-overlay"),po=document.getElementById("overlay-image"),mo=document.getElementById("close-overlay"),go=document.querySelector(".overlay-prev"),_o=document.querySelector(".overlay-next");let _t=[],Ht=0;function vi(){!po||_t.length===0||(po.src=_t[Ht])}function hl(n,e=0){Jt&&(_t=Array.isArray(n)?n.slice():[],Ht=Math.min(Math.max(e,0),_t.length-1),vi(),Jt.classList.remove("hidden"))}mo&&mo.addEventListener("click",()=>Jt.classList.add("hidden"));Jt&&Jt.addEventListener("click",n=>{n.target===Jt&&Jt.classList.add("hidden")});go&&go.addEventListener("click",n=>{n.preventDefault(),_t.length!==0&&(Ht=(Ht-1+_t.length)%_t.length,vi())});_o&&_o.addEventListener("click",n=>{n.preventDefault(),_t.length!==0&&(Ht=(Ht+1)%_t.length,vi())});window.addEventListener("keydown",n=>{!Jt||Jt.classList.contains("hidden")||(n.key==="ArrowRight"?_t.length>0&&(Ht=(Ht+1)%_t.length,vi()):n.key==="ArrowLeft"&&_t.length>0&&(Ht=(Ht-1+_t.length)%_t.length,vi()))});window.addEventListener("open-overlay",n=>{const e=n.detail||{},t=e.images||[],i=e.index||0;hl(t,i)});
